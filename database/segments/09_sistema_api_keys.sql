-- ============================================================================
-- SEGMENTO 09: SISTEMA DE API KEYS Y TRACKING DE PETICIONES
-- ============================================================================
-- Descripción: Sistema de autenticación por API Keys para aplicaciones
--              separado de la autenticación de usuarios
--              - api_applications: Aplicaciones que usan API Keys
--              - api_keys: Claves de API con scopes y rate limits
--              - api_request_logs: Logs de peticiones API
-- 
-- Dependencias: Schema commerce (Segmento 06)
-- Orden de ejecución: 09
-- ============================================================================
