...
const settingsSections: SettingsSection[] = [
  {
    ...
    categories: allCategories.filter(c => c.section === 'PROJECT SETTINGS'),
  },
  {
    title: 'CONFIGURATION',
    categories: allCategories.filter(c => c.section === 'CONFIGURATION'),
  },
];
    ...
    <>
      ...
      <AdminLayout>
        <div className="flex h-full bg-gray-50">
          {/* Sidebar: Categorías estilo Supabase */}
