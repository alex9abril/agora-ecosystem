...
export class UpdateBusinessGroupDto {
  @ApiPropertyOptional({ description: 'Nombre comercial del grupo empresarial', example: 'Grupo Andrade' })
  @IsOptional()
  @IsString()
  @MaxLength(255)
  name?: string;
  ...
  @ApiPropertyOptional({ description: 'Slug amigable para URLs', example: 'grupo-andrade' })
  @IsOptional()
  @IsString()
  @MaxLength(255)
  slug?: string;
  ...
  @ApiPropertyOptional({ description: 'Si el grupo está activo', example: true })
  @IsOptional()
  @IsBoolean()
  @Type(() => Boolean)
  is_active?: boolean;
