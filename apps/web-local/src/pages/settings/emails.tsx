...
<body style="margin: 0; padding: 0; background-color: #333; font-family: Arial, sans-serif; line-height: 1.6; color: #111827;">
  ...
  <div style="max-width: 600px; margin: -40px auto 0 auto; background-color: #ffffff; border-radius: 16px 16px 0 0; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.1); position: relative; padding: 50px 40px 40px 40px;">
    ...
    <!-- Título principal -->
    <h1 style="text-align: center; font-size: 32px; font-weight: 700; color: #111827; margin: 0 0 14px 0; line-height: 1.2; font-family: Arial, sans-serif;">
      {{subject}}
    </h1>

    <!-- Subtítulo -->
    <p style="text-align: center; font-size: 16px; color: #4b5563; margin: 0 0 34px 0; line-height: 1.6; font-family: Arial, sans-serif;">
    ...
    <div style="background-color: #f9fafb; border-radius: 12px; padding: 24px; margin-bottom: 28px; border: 1px solid #e5e7eb;">
      <p style="font-size: 14px; color: #6b7280; margin: 0 0 14px 0; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 500; font-family: Arial, sans-serif;">
        Mensaje
      </p>
      {{message_body}}
    </div>
