/**
 * Componente para cargar imágenes de sliders
 * Basado en la funcionalidad de BrandingManager de web-admin
 */
...
export default function SliderImageUpload({
  ...
  const handleUploadImage = async (file: File) => {
    ...
    try {
      ...
      const endpoint = contextType === 'group'
        ? `/landing-sliders/upload-image/group/${contextId}`
        : `/landing-sliders/upload-image/branch/${contextId}`;
