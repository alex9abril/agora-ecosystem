...
interface Branding {
  ...
  custom_css?: string;
  custom_js?: string;
  /** Si la tienda se mostrará embebida en iframe en el portal del cliente (subdominio). */
  embed_mode?: boolean;
              ...
              <div className="bg-gray-50 dark:bg-neutral-700/50 rounded-lg border border-gray-200 dark:border-neutral-600 p-4">
                <div className="flex items-start gap-3">
                  <input
                    ...
                    className="mt-1 h-4 w-4 rounded border-gray-300 dark:border-neutral-500 text-indigo-600 focus:ring-indigo-500 bg-white dark:bg-neutral-700"
                  />
                  <div className="flex-1">
                ...
                {branding.embed_mode && (
                  <div className="flex items-start gap-3 mt-4 pt-4 border-t border-gray-200 dark:border-neutral-600">
                    <input
                      type="checkbox"
                      id="embed_show_logo"
                      checked={branding.embed_show_logo !== false}
                      onChange={(e) => setBranding({ ...branding, embed_show_logo: e.target.checked })}
                      className="mt-1 h-4 w-4 rounded border-gray-300 dark:border-neutral-500 text-indigo-600 focus:ring-indigo-500 bg-white dark:bg-neutral-700"
                    />
                    <div className="flex-1">
                      <label htmlFor="embed_show_logo" className="text-sm font-medium text-gray-900 dark:text-gray-100 cursor-pointer">
                        Mostrar logotipo de la tienda en el header
                      </label>
                      <p className="text-xs text-gray-600 dark:text-gray-400 mt-1.5">
                        Desactívalo si el sitio que embebe la tienda ya muestra su propio logo, para evitar duplicar el logotipo.
                      </p>
                    </div>
                  </div>
                )}
              ...
              <div className="bg-gray-50 dark:bg-neutral-700/50 rounded-lg border border-gray-200 dark:border-neutral-600 p-4">
                ...
                <div className="flex flex-wrap gap-4">
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    />
                    <span className="text-sm text-gray-900 dark:text-gray-100">Ancho completo</span>
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      type="radio"
                      ...
                      className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500"
                    />
                    <span className="text-sm text-gray-900 dark:text-gray-100">Contenedor central</span>
                  </label>
                </div>
