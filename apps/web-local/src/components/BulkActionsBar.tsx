          ...
          {showDeleteConfirm ? (
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-red-600 hover:bg-red-500 disabled:opacity-50 transition-colors text-white text-xs font-medium whitespace-nowrap"
              >
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-gray-700 hover:bg-gray-600 disabled:opacity-50 transition-colors text-xs whitespace-nowrap"
              >
                Cancelar
              </button>
            </div>
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-red-900/70 hover:bg-red-700 disabled:opacity-50 transition-colors text-red-300 hover:text-white whitespace-nowrap"
            >
              <svg className="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
