...
export interface CreateSliderFormProps {
  ...
  return (
    <div className="bg-white dark:bg-neutral-800 rounded-lg border border-gray-200 dark:border-neutral-700 p-6 space-y-6">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">Nuevo slider</h3>
        <button
          type="button"
          onClick={onCancel}
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          />
          <label htmlFor="create-slider-active" className="text-sm text-gray-700 dark:text-gray-300">
