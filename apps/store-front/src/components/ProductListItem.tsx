...
export default function ProductListItem({ product, onAddToCart, overridePrice, pricePending, isCompatible }: ProductListItemProps) {
      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-lg transition-all duration-200 cursor-pointer group h-full">
        <div className="flex flex-row">
          ...
          <div className="w-48 h-48 bg-gray-100 relative overflow-hidden flex items-center justify-center flex-shrink-0">
            ...
            {/* Badge de Destacado */}
            {product.is_featured && (
              <div className={`absolute left-2 z-10 bg-toyota-red text-white px-2 py-1 rounded-md text-xs font-semibold shadow-md flex items-center gap-1 ${
                isCompatible ? 'top-10' : 'top-2'
              }`}>
